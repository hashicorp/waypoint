...
type Deployment struct {
	...
	ResourceState   *any.Any `protobuf:"bytes,7,opt,name=resource_state,json=resourceState,proto3" json:"resource_state,omitempty"`
}
...
type Resource_Alb_RedirectListener struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *Resource_Alb_RedirectListener) Reset() {
	*x = Resource_Alb_RedirectListener{}
	if protoimpl.UnsafeEnabled {
...
func (x *Resource_Alb_RedirectListener) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Resource_Alb_RedirectListener) ProtoMessage() {}

func (x *Resource_Alb_RedirectListener) ProtoReflect() protoreflect.Message {
	mi := &file_waypoint_builtin_aws_ecs_plugin_proto_msgTypes[20]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Resource_Alb_RedirectListener.ProtoReflect.Descriptor instead.
func (*Resource_Alb_RedirectListener) Descriptor() ([]byte, []int) {
	return file_waypoint_builtin_aws_ecs_plugin_proto_rawDescGZIP(), []int{2, 12, 1}
}

func (x *Resource_Alb_RedirectListener) GetArn() string {
	if x != nil {
		return x.Arn
	}
	return ""
...
var file_waypoint_builtin_aws_ecs_plugin_proto_rawDesc = []byte{
	...
	0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x72, 0x41, 0x72, 0x6e, 0x22, 0xd7, 0x0a, 0x0a, 0x08, 0x52,
	...
	0x1a, 0xb5, 0x02, 0x0a, 0x03, 0x41, 0x6c, 0x62, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65,
	...
	0x65, 0x64, 0x1a, 0x24, 0x0a, 0x10, 0x52, 0x65, 0x64, 0x69, 0x72, 0x65, 0x63, 0x74, 0x4c, 0x69,
	0x73, 0x74, 0x65, 0x6e, 0x65, 0x72, 0x12, 0x10, 0x0a, 0x03, 0x61, 0x72, 0x6e, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x03, 0x61, 0x72, 0x6e, 0x1a, 0x3c, 0x0a, 0x0e, 0x54, 0x61, 0x73, 0x6b,
	0x44, 0x65, 0x66, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x10, 0x0a, 0x03, 0x61, 0x72,
	...
	0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x1a, 0x3c, 0x0a, 0x0d, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x35,
	0x33, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x17, 0x0a, 0x07, 0x7a,
	0x6f, 0x6e, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x7a, 0x6f,
	0x6e, 0x65, 0x49, 0x64, 0x42, 0x1a, 0x5a, 0x18, 0x77, 0x61, 0x79, 0x70, 0x6f, 0x69, 0x6e, 0x74,
	0x2f, 0x62, 0x75, 0x69, 0x6c, 0x74, 0x69, 0x6e, 0x2f, 0x61, 0x77, 0x73, 0x2f, 0x65, 0x63, 0x73,
...
var file_waypoint_builtin_aws_ecs_plugin_proto_goTypes = []interface{}{
	...
	(*Resource_Alb_RedirectListener)(nil),   // 20: ecs.Resource.Alb.RedirectListener
...
func file_waypoint_builtin_aws_ecs_plugin_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_waypoint_builtin_aws_ecs_plugin_proto_msgTypes[20].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Resource_Alb_RedirectListener); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
