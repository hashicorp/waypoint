...
type Deployment struct {
	...
	//
	// Types that are assignable to LbReference:
	//
	//	*Deployment_LoadBalancerArn
	//	*Deployment_ListenerArn
	LbReference   isDeployment_LbReference `protobuf_oneof:"lb_reference"`
...
func (m *Deployment) GetLbReference() isDeployment_LbReference {
	if m != nil {
		return m.LbReference
	}
	return nil
}

func (x *Deployment) GetLoadBalancerArn() string {
	if x, ok := x.GetLbReference().(*Deployment_LoadBalancerArn); ok {
...
func (x *Deployment) GetListenerArn() string {
	if x, ok := x.GetLbReference().(*Deployment_ListenerArn); ok {
...
type isDeployment_LbReference interface {
	isDeployment_LbReference()
}

type Deployment_LoadBalancerArn struct {
	LoadBalancerArn string `protobuf:"bytes,5,opt,name=load_balancer_arn,json=loadBalancerArn,proto3,oneof"`
}

type Deployment_ListenerArn struct {
	ListenerArn string `protobuf:"bytes,8,opt,name=listener_arn,json=listenerArn,proto3,oneof"`
}

func (*Deployment_LoadBalancerArn) isDeployment_LbReference() {}

func (*Deployment_ListenerArn) isDeployment_LbReference() {}
...
var file_waypoint_builtin_aws_ecs_plugin_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0xb8, 0x02, 0x0a, 0x0a, 0x44, 0x65, 0x70, 0x6c, 0x6f, 0x79, 0x6d, 0x65, 0x6e, 0x74,
	...
	0x47, 0x72, 0x6f, 0x75, 0x70, 0x41, 0x72, 0x6e, 0x12, 0x2c, 0x0a, 0x11, 0x6c, 0x6f, 0x61, 0x64,
	0x5f, 0x62, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x72, 0x5f, 0x61, 0x72, 0x6e, 0x18, 0x05, 0x20,
	0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x0f, 0x6c, 0x6f, 0x61, 0x64, 0x42, 0x61, 0x6c, 0x61, 0x6e,
	0x63, 0x65, 0x72, 0x41, 0x72, 0x6e, 0x12, 0x23, 0x0a, 0x0c, 0x6c, 0x69, 0x73, 0x74, 0x65, 0x6e,
	0x65, 0x72, 0x5f, 0x61, 0x72, 0x6e, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x0b,
	...
	0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x53, 0x74, 0x61, 0x74, 0x65, 0x42, 0x0e, 0x0a, 0x0c,
	0x6c, 0x62, 0x5f, 0x72, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x22, 0x47, 0x0a, 0x07,
...
func file_waypoint_builtin_aws_ecs_plugin_proto_init() {
	...
	file_waypoint_builtin_aws_ecs_plugin_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*Deployment_LoadBalancerArn)(nil),
		(*Deployment_ListenerArn)(nil),
	}
	type x struct{}
