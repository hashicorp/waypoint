...
type Resource_AcmCertificate struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *Resource_AcmCertificate) Reset() {
	*x = Resource_AcmCertificate{}
	if protoimpl.UnsafeEnabled {
...
func (x *Resource_AcmCertificate) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Resource_AcmCertificate) ProtoMessage() {}

func (x *Resource_AcmCertificate) ProtoReflect() protoreflect.Message {
	mi := &file_waypoint_builtin_aws_ecs_plugin_proto_msgTypes[18]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Resource_AcmCertificate.ProtoReflect.Descriptor instead.
func (*Resource_AcmCertificate) Descriptor() ([]byte, []int) {
	return file_waypoint_builtin_aws_ecs_plugin_proto_rawDescGZIP(), []int{2, 15}
}

func (x *Resource_AcmCertificate) GetArn() string {
	if x != nil {
		return x.Arn
	}
	return ""
...
var file_waypoint_builtin_aws_ecs_plugin_proto_rawDesc = []byte{
	...
	0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x72, 0x41, 0x72, 0x6e, 0x22, 0xd5, 0x0a, 0x0a, 0x08, 0x52,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x7a, 0x6f, 0x6e, 0x65, 0x49, 0x64, 0x1a, 0x22,
	0x0a, 0x0e, 0x41, 0x63, 0x6d, 0x43, 0x65, 0x72, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x65,
...
var file_waypoint_builtin_aws_ecs_plugin_proto_goTypes = []interface{}{
	...
	(*Resource_AcmCertificate)(nil),         // 18: ecs.Resource.AcmCertificate
...
func file_waypoint_builtin_aws_ecs_plugin_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_waypoint_builtin_aws_ecs_plugin_proto_msgTypes[18].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Resource_AcmCertificate); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
