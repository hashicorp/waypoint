...
func (x *Release) Reset() {
	*x = Release{}
	if protoimpl.UnsafeEnabled {
		mi := &file_waypoint_builtin_aws_ec2_plugin_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Release) Descriptor() ([]byte, []int) {
	return file_waypoint_builtin_aws_ec2_plugin_proto_rawDescGZIP(), []int{1}
}
...
var file_waypoint_builtin_aws_ec2_plugin_proto_rawDesc = []byte{
	...
	0x72, 0x67, 0x65, 0x74, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x41, 0x72, 0x6e, 0x22, 0x47, 0x0a, 0x07,
	...
	0x65, 0x72, 0x41, 0x72, 0x6e, 0x42, 0x1a, 0x5a, 0x18, 0x77, 0x61, 0x79, 0x70, 0x6f, 0x69, 0x6e,
...
var file_waypoint_builtin_aws_ec2_plugin_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_waypoint_builtin_aws_ec2_plugin_proto_goTypes = []interface{}{
	(*Deployment)(nil), // 0: ec2.Deployment
	(*Release)(nil),    // 1: ec2.Release
}
...
func file_waypoint_builtin_aws_ec2_plugin_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_waypoint_builtin_aws_ec2_plugin_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
