...
-> **Note:** The Waypoint entrypoint and the [Nomad entrypoint functionality](https://www.waypointproject.io/plugins/nomad#entrypoint-functionality) 
cannot be used simultaneously. In order to use the features of the Waypoint entrypoint, the Nomad entrypoint must not also be used in your jobspec.
