...
//go:generate protoc -I ../../.. -I ../../thirdparty/proto --go_opt=paths=source_relative --go_out=../../.. --go-grpc_opt=paths=source_relative --go-grpc_out=../../.. waypoint/builtin/k8s/plugin.proto
