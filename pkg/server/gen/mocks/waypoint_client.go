...
// ListActivityFeedSchemas provides a mock function with given fields: ctx, in, opts
func (_m *WaypointClient) ListActivityFeedSchemas(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*gen.ListActivityFeedSchemasResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 *gen.ListActivityFeedSchemasResponse
	if rf, ok := ret.Get(0).(func(context.Context, *emptypb.Empty, ...grpc.CallOption) *gen.ListActivityFeedSchemasResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*gen.ListActivityFeedSchemasResponse)
		}
	}
