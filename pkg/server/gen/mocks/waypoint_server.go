...
// ListActivityFeedSchemas provides a mock function with given fields: _a0, _a1
func (_m *WaypointServer) ListActivityFeedSchemas(_a0 context.Context, _a1 *emptypb.Empty) (*gen.ListActivityFeedSchemasResponse, error) {
	ret := _m.Called(_a0, _a1)

	var r0 *gen.ListActivityFeedSchemasResponse
	if rf, ok := ret.Get(0).(func(context.Context, *emptypb.Empty) *gen.ListActivityFeedSchemasResponse); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
