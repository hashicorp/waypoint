...
func (a *App) Exec(ctx context.Context, id string, d *pb.Deployment, enableDynConfig bool) error {
	...
	virt, err := virtualceb.NewVirtual(a.logger, virtualceb.VirtualConfig{
		DeploymentId:        d.Id,
		InstanceId:          id,
		Client:              a.client,
...
// pluginExecVirtHandler is an implementation of virtualceb.VirtualExecHandler
...
type pluginExecVirtHandler struct {
	...
	info *virtualceb.VirtualExecInfo
...
func (p *pluginExecVirtHandler) CreateSession(
	ctx context.Context,
	info *virtualceb.VirtualExecInfo,
) (virtualceb.VirtualExecSession, error) {
