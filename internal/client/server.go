...
func New(
	...
	versionInfo, err := NegotiateApiVersion(ctx, client, log)
	if err != nil {
		return nil, nil, err
	}
...
//func initLocalServer(ctx context.Context, log hclog.Logger) (*grpc.ClientConn, error) {
//	// TODO(izaak): the caller should do this
