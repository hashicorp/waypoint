...
// SetMetadata provides a mock function with given fields: ctx, in, opts
func (_m *WaypointClient) SetMetadata(ctx context.Context, in *gen.MetadataSetRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 *emptypb.Empty
	if rf, ok := ret.Get(0).(func(context.Context, *gen.MetadataSetRequest, ...grpc.CallOption) *emptypb.Empty); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*emptypb.Empty)
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *gen.MetadataSetRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
