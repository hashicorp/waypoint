...
var file_internal_server_proto_server_proto_rawDesc = []byte{
	...
	0x6e, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6c, 0x69, 0x6e, 0x65, 0x22, 0xad,
	...
	0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x22, 0xe4, 0x05, 0x0a, 0x10, 0x45, 0x6e, 0x74, 0x72, 0x79,
	...
	0x65, 0x6e, 0x74, 0x22, 0x9d, 0x01, 0x0a, 0x16, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x70, 0x6f, 0x69,
	...
	0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x32, 0xc1, 0x26, 0x0a, 0x08,
...
var file_internal_server_proto_server_proto_msgTypes = make([]protoimpl.MessageInfo, 207)
var file_internal_server_proto_server_proto_goTypes = []interface{}{
	...
	(*ConfigVar_DynamicVal)(nil),                            // 193: hashicorp.waypoint.ConfigVar.DynamicVal
	nil,                                                     // 194: hashicorp.waypoint.ConfigVar.DynamicVal.ConfigEntry
	(*ExecStreamRequest_Start)(nil),                         // 195: hashicorp.waypoint.ExecStreamRequest.Start
	(*ExecStreamRequest_Input)(nil),                         // 196: hashicorp.waypoint.ExecStreamRequest.Input
	(*ExecStreamRequest_PTY)(nil),                           // 197: hashicorp.waypoint.ExecStreamRequest.PTY
	(*ExecStreamRequest_WindowSize)(nil),                    // 198: hashicorp.waypoint.ExecStreamRequest.WindowSize
	(*ExecStreamResponse_Open)(nil),                         // 199: hashicorp.waypoint.ExecStreamResponse.Open
	(*ExecStreamResponse_Exit)(nil),                         // 200: hashicorp.waypoint.ExecStreamResponse.Exit
	(*ExecStreamResponse_Output)(nil),                       // 201: hashicorp.waypoint.ExecStreamResponse.Output
	(*EntrypointConfig_Exec)(nil),                           // 202: hashicorp.waypoint.EntrypointConfig.Exec
	(*EntrypointConfig_URLService)(nil),                     // 203: hashicorp.waypoint.EntrypointConfig.URLService
	(*EntrypointConfig_DeploymentInfo)(nil),                 // 204: hashicorp.waypoint.EntrypointConfig.DeploymentInfo
	nil,                                                     // 205: hashicorp.waypoint.EntrypointConfig.DeploymentInfo.LabelsEntry
	(*EntrypointExecRequest_Open)(nil),                      // 206: hashicorp.waypoint.EntrypointExecRequest.Open
	(*EntrypointExecRequest_Exit)(nil),                      // 207: hashicorp.waypoint.EntrypointExecRequest.Exit
	(*EntrypointExecRequest_Output)(nil),                    // 208: hashicorp.waypoint.EntrypointExecRequest.Output
	(*EntrypointExecRequest_Error)(nil),                     // 209: hashicorp.waypoint.EntrypointExecRequest.Error
	nil,                                                     // 210: hashicorp.waypoint.TokenTransport.MetadataEntry
	(*Token_Entrypoint)(nil),                                // 211: hashicorp.waypoint.Token.Entrypoint
	(*CreateSnapshotResponse_Open)(nil),                     // 212: hashicorp.waypoint.CreateSnapshotResponse.Open
	(*RestoreSnapshotRequest_Open)(nil),                     // 213: hashicorp.waypoint.RestoreSnapshotRequest.Open
	(*Snapshot_Header)(nil),                                 // 214: hashicorp.waypoint.Snapshot.Header
	(*Snapshot_Trailer)(nil),                                // 215: hashicorp.waypoint.Snapshot.Trailer
	(*Snapshot_BoltChunk)(nil),                              // 216: hashicorp.waypoint.Snapshot.BoltChunk
	nil,                                                     // 217: hashicorp.waypoint.Snapshot.BoltChunk.ItemsEntry
	(*timestamp.Timestamp)(nil),                             // 218: google.protobuf.Timestamp
	(*status.Status)(nil),                                   // 219: google.rpc.Status
	(*any.Any)(nil),                                         // 220: google.protobuf.Any
...
var file_internal_server_proto_server_proto_depIdxs = []int32{
	...
	218, // 7: hashicorp.waypoint.Workspace.active_time:type_name -> google.protobuf.Timestamp
	...
	219, // 10: hashicorp.waypoint.Status.error:type_name -> google.rpc.Status
	218, // 11: hashicorp.waypoint.Status.start_time:type_name -> google.protobuf.Timestamp
	218, // 12: hashicorp.waypoint.Status.complete_time:type_name -> google.protobuf.Timestamp
	...
	219, // 17: hashicorp.waypoint.ValidateJobResponse.validation_error:type_name -> google.rpc.Status
	...
	218, // 35: hashicorp.waypoint.Job.queue_time:type_name -> google.protobuf.Timestamp
	218, // 36: hashicorp.waypoint.Job.assign_time:type_name -> google.protobuf.Timestamp
	218, // 37: hashicorp.waypoint.Job.ack_time:type_name -> google.protobuf.Timestamp
	218, // 38: hashicorp.waypoint.Job.complete_time:type_name -> google.protobuf.Timestamp
	219, // 39: hashicorp.waypoint.Job.error:type_name -> google.rpc.Status
	131, // 40: hashicorp.waypoint.Job.result:type_name -> hashicorp.waypoint.Job.Result
	218, // 41: hashicorp.waypoint.Job.cancel_time:type_name -> google.protobuf.Timestamp
	218, // 42: hashicorp.waypoint.Job.expire_time:type_name -> google.protobuf.Timestamp
	...
	220, // 96: hashicorp.waypoint.Artifact.artifact:type_name -> google.protobuf.Any
	...
	220, // 131: hashicorp.waypoint.Deployment.deployment:type_name -> google.protobuf.Any
	...
	220, // 157: hashicorp.waypoint.Release.release:type_name -> google.protobuf.Any
	...
	221, // 165: hashicorp.waypoint.ConfigVar.unset:type_name -> google.protobuf.Empty
	193, // 166: hashicorp.waypoint.ConfigVar.dynamic:type_name -> hashicorp.waypoint.ConfigVar.DynamicVal
	95,  // 167: hashicorp.waypoint.ConfigSetRequest.variables:type_name -> hashicorp.waypoint.ConfigVar
	119, // 168: hashicorp.waypoint.ConfigGetRequest.application:type_name -> hashicorp.waypoint.Ref.Application
	120, // 169: hashicorp.waypoint.ConfigGetRequest.project:type_name -> hashicorp.waypoint.Ref.Project
	126, // 170: hashicorp.waypoint.ConfigGetRequest.runner:type_name -> hashicorp.waypoint.Ref.RunnerId
	95,  // 171: hashicorp.waypoint.ConfigGetResponse.variables:type_name -> hashicorp.waypoint.ConfigVar
	195, // 172: hashicorp.waypoint.ExecStreamRequest.start:type_name -> hashicorp.waypoint.ExecStreamRequest.Start
	196, // 173: hashicorp.waypoint.ExecStreamRequest.input:type_name -> hashicorp.waypoint.ExecStreamRequest.Input
	198, // 174: hashicorp.waypoint.ExecStreamRequest.winch:type_name -> hashicorp.waypoint.ExecStreamRequest.WindowSize
	199, // 175: hashicorp.waypoint.ExecStreamResponse.open:type_name -> hashicorp.waypoint.ExecStreamResponse.Open
	201, // 176: hashicorp.waypoint.ExecStreamResponse.output:type_name -> hashicorp.waypoint.ExecStreamResponse.Output
	200, // 177: hashicorp.waypoint.ExecStreamResponse.exit:type_name -> hashicorp.waypoint.ExecStreamResponse.Exit
	104, // 178: hashicorp.waypoint.EntrypointConfigResponse.config:type_name -> hashicorp.waypoint.EntrypointConfig
	202, // 179: hashicorp.waypoint.EntrypointConfig.exec:type_name -> hashicorp.waypoint.EntrypointConfig.Exec
	95,  // 180: hashicorp.waypoint.EntrypointConfig.env_vars:type_name -> hashicorp.waypoint.ConfigVar
	203, // 181: hashicorp.waypoint.EntrypointConfig.url_service:type_name -> hashicorp.waypoint.EntrypointConfig.URLService
	204, // 182: hashicorp.waypoint.EntrypointConfig.deployment:type_name -> hashicorp.waypoint.EntrypointConfig.DeploymentInfo
	192, // 183: hashicorp.waypoint.EntrypointLogBatch.lines:type_name -> hashicorp.waypoint.LogBatch.Entry
	206, // 184: hashicorp.waypoint.EntrypointExecRequest.open:type_name -> hashicorp.waypoint.EntrypointExecRequest.Open
	207, // 185: hashicorp.waypoint.EntrypointExecRequest.exit:type_name -> hashicorp.waypoint.EntrypointExecRequest.Exit
	208, // 186: hashicorp.waypoint.EntrypointExecRequest.output:type_name -> hashicorp.waypoint.EntrypointExecRequest.Output
	209, // 187: hashicorp.waypoint.EntrypointExecRequest.error:type_name -> hashicorp.waypoint.EntrypointExecRequest.Error
	198, // 188: hashicorp.waypoint.EntrypointExecResponse.winch:type_name -> hashicorp.waypoint.ExecStreamRequest.WindowSize
	210, // 189: hashicorp.waypoint.TokenTransport.metadata:type_name -> hashicorp.waypoint.TokenTransport.MetadataEntry
	218, // 190: hashicorp.waypoint.Token.valid_until:type_name -> google.protobuf.Timestamp
	211, // 191: hashicorp.waypoint.Token.entrypoint:type_name -> hashicorp.waypoint.Token.Entrypoint
	211, // 192: hashicorp.waypoint.InviteTokenRequest.entrypoint:type_name -> hashicorp.waypoint.Token.Entrypoint
	212, // 193: hashicorp.waypoint.CreateSnapshotResponse.open:type_name -> hashicorp.waypoint.CreateSnapshotResponse.Open
	213, // 194: hashicorp.waypoint.RestoreSnapshotRequest.open:type_name -> hashicorp.waypoint.RestoreSnapshotRequest.Open
	119, // 195: hashicorp.waypoint.Workspace.Application.application:type_name -> hashicorp.waypoint.Ref.Application
	218, // 196: hashicorp.waypoint.Workspace.Application.active_time:type_name -> google.protobuf.Timestamp
	0,   // 197: hashicorp.waypoint.Ref.Component.type:type_name -> hashicorp.waypoint.Component.Type
	124, // 198: hashicorp.waypoint.Ref.Operation.sequence:type_name -> hashicorp.waypoint.Ref.OperationSeq
	119, // 199: hashicorp.waypoint.Ref.OperationSeq.application:type_name -> hashicorp.waypoint.Ref.Application
	127, // 200: hashicorp.waypoint.Ref.Runner.any:type_name -> hashicorp.waypoint.Ref.RunnerAny
	126, // 201: hashicorp.waypoint.Ref.Runner.id:type_name -> hashicorp.waypoint.Ref.RunnerId
	1,   // 202: hashicorp.waypoint.StatusFilter.Filter.state:type_name -> hashicorp.waypoint.Status.State
	141, // 203: hashicorp.waypoint.Job.Result.build:type_name -> hashicorp.waypoint.Job.BuildResult
	143, // 204: hashicorp.waypoint.Job.Result.push:type_name -> hashicorp.waypoint.Job.PushResult
	145, // 205: hashicorp.waypoint.Job.Result.deploy:type_name -> hashicorp.waypoint.Job.DeployResult
	148, // 206: hashicorp.waypoint.Job.Result.release:type_name -> hashicorp.waypoint.Job.ReleaseResult
	137, // 207: hashicorp.waypoint.Job.Result.validate:type_name -> hashicorp.waypoint.Job.ValidateResult
	139, // 208: hashicorp.waypoint.Job.Result.auth:type_name -> hashicorp.waypoint.Job.AuthResult
	150, // 209: hashicorp.waypoint.Job.Result.docs:type_name -> hashicorp.waypoint.Job.DocsResult
	133, // 210: hashicorp.waypoint.Job.DataSource.local:type_name -> hashicorp.waypoint.Job.Local
	134, // 211: hashicorp.waypoint.Job.DataSource.git:type_name -> hashicorp.waypoint.Job.Git
	122, // 212: hashicorp.waypoint.Job.AuthOp.component:type_name -> hashicorp.waypoint.Ref.Component
	151, // 213: hashicorp.waypoint.Job.AuthResult.results:type_name -> hashicorp.waypoint.Job.AuthResult.Result
	68,  // 214: hashicorp.waypoint.Job.BuildResult.build:type_name -> hashicorp.waypoint.Build
	76,  // 215: hashicorp.waypoint.Job.BuildResult.push:type_name -> hashicorp.waypoint.PushedArtifact
	68,  // 216: hashicorp.waypoint.Job.PushOp.build:type_name -> hashicorp.waypoint.Build
	76,  // 217: hashicorp.waypoint.Job.PushResult.artifact:type_name -> hashicorp.waypoint.PushedArtifact
	76,  // 218: hashicorp.waypoint.Job.DeployOp.artifact:type_name -> hashicorp.waypoint.PushedArtifact
	82,  // 219: hashicorp.waypoint.Job.DeployResult.deployment:type_name -> hashicorp.waypoint.Deployment
	221, // 220: hashicorp.waypoint.Job.DestroyOp.workspace:type_name -> google.protobuf.Empty
	82,  // 221: hashicorp.waypoint.Job.DestroyOp.deployment:type_name -> hashicorp.waypoint.Deployment
	82,  // 222: hashicorp.waypoint.Job.ReleaseOp.deployment:type_name -> hashicorp.waypoint.Deployment
	92,  // 223: hashicorp.waypoint.Job.ReleaseResult.release:type_name -> hashicorp.waypoint.Release
	152, // 224: hashicorp.waypoint.Job.DocsResult.results:type_name -> hashicorp.waypoint.Job.DocsResult.Result
	17,  // 225: hashicorp.waypoint.Job.AuthResult.Result.component:type_name -> hashicorp.waypoint.Component
	219, // 226: hashicorp.waypoint.Job.AuthResult.Result.check_error:type_name -> google.rpc.Status
	219, // 227: hashicorp.waypoint.Job.AuthResult.Result.auth_error:type_name -> google.rpc.Status
	17,  // 228: hashicorp.waypoint.Job.DocsResult.Result.component:type_name -> hashicorp.waypoint.Component
	28,  // 229: hashicorp.waypoint.Job.DocsResult.Result.docs:type_name -> hashicorp.waypoint.Documentation
	154, // 230: hashicorp.waypoint.Documentation.FieldsEntry.value:type_name -> hashicorp.waypoint.Documentation.Field
	4,   // 231: hashicorp.waypoint.GetJobStreamResponse.State.previous:type_name -> hashicorp.waypoint.Job.State
	4,   // 232: hashicorp.waypoint.GetJobStreamResponse.State.current:type_name -> hashicorp.waypoint.Job.State
	27,  // 233: hashicorp.waypoint.GetJobStreamResponse.State.job:type_name -> hashicorp.waypoint.Job
	161, // 234: hashicorp.waypoint.GetJobStreamResponse.Terminal.events:type_name -> hashicorp.waypoint.GetJobStreamResponse.Terminal.Event
	219, // 235: hashicorp.waypoint.GetJobStreamResponse.Error.error:type_name -> google.rpc.Status
	219, // 236: hashicorp.waypoint.GetJobStreamResponse.Complete.error:type_name -> google.rpc.Status
	131, // 237: hashicorp.waypoint.GetJobStreamResponse.Complete.result:type_name -> hashicorp.waypoint.Job.Result
	218, // 238: hashicorp.waypoint.GetJobStreamResponse.Terminal.Event.timestamp:type_name -> google.protobuf.Timestamp
	163, // 239: hashicorp.waypoint.GetJobStreamResponse.Terminal.Event.line:type_name -> hashicorp.waypoint.GetJobStreamResponse.Terminal.Event.Line
	162, // 240: hashicorp.waypoint.GetJobStreamResponse.Terminal.Event.status:type_name -> hashicorp.waypoint.GetJobStreamResponse.Terminal.Event.Status
	166, // 241: hashicorp.waypoint.GetJobStreamResponse.Terminal.Event.named_values:type_name -> hashicorp.waypoint.GetJobStreamResponse.Terminal.Event.NamedValues
	164, // 242: hashicorp.waypoint.GetJobStreamResponse.Terminal.Event.raw:type_name -> hashicorp.waypoint.GetJobStreamResponse.Terminal.Event.Raw
	169, // 243: hashicorp.waypoint.GetJobStreamResponse.Terminal.Event.table:type_name -> hashicorp.waypoint.GetJobStreamResponse.Terminal.Event.Table
	170, // 244: hashicorp.waypoint.GetJobStreamResponse.Terminal.Event.step_group:type_name -> hashicorp.waypoint.GetJobStreamResponse.Terminal.Event.StepGroup
	171, // 245: hashicorp.waypoint.GetJobStreamResponse.Terminal.Event.step:type_name -> hashicorp.waypoint.GetJobStreamResponse.Terminal.Event.Step
	165, // 246: hashicorp.waypoint.GetJobStreamResponse.Terminal.Event.NamedValues.values:type_name -> hashicorp.waypoint.GetJobStreamResponse.Terminal.Event.NamedValue
	167, // 247: hashicorp.waypoint.GetJobStreamResponse.Terminal.Event.TableRow.entries:type_name -> hashicorp.waypoint.GetJobStreamResponse.Terminal.Event.TableEntry
	168, // 248: hashicorp.waypoint.GetJobStreamResponse.Terminal.Event.Table.rows:type_name -> hashicorp.waypoint.GetJobStreamResponse.Terminal.Event.TableRow
	34,  // 249: hashicorp.waypoint.RunnerConfigRequest.Open.runner:type_name -> hashicorp.waypoint.Runner
	131, // 250: hashicorp.waypoint.RunnerJobStreamRequest.Complete.result:type_name -> hashicorp.waypoint.Job.Result
	219, // 251: hashicorp.waypoint.RunnerJobStreamRequest.Error.error:type_name -> google.rpc.Status
	27,  // 252: hashicorp.waypoint.RunnerJobStreamResponse.JobAssignment.job:type_name -> hashicorp.waypoint.Job
	183, // 253: hashicorp.waypoint.Hostname.Target.application:type_name -> hashicorp.waypoint.Hostname.TargetApp
	119, // 254: hashicorp.waypoint.Hostname.TargetApp.application:type_name -> hashicorp.waypoint.Ref.Application
	121, // 255: hashicorp.waypoint.Hostname.TargetApp.workspace:type_name -> hashicorp.waypoint.Ref.Workspace
	76,  // 256: hashicorp.waypoint.Deployment.Preload.artifact:type_name -> hashicorp.waypoint.PushedArtifact
	68,  // 257: hashicorp.waypoint.Deployment.Preload.build:type_name -> hashicorp.waypoint.Build
	119, // 258: hashicorp.waypoint.ListInstancesRequest.Application.application:type_name -> hashicorp.waypoint.Ref.Application
	121, // 259: hashicorp.waypoint.ListInstancesRequest.Application.workspace:type_name -> hashicorp.waypoint.Ref.Workspace
	82,  // 260: hashicorp.waypoint.Release.Preload.deployment:type_name -> hashicorp.waypoint.Deployment
	76,  // 261: hashicorp.waypoint.Release.Preload.artifact:type_name -> hashicorp.waypoint.PushedArtifact
	68,  // 262: hashicorp.waypoint.Release.Preload.build:type_name -> hashicorp.waypoint.Build
	119, // 263: hashicorp.waypoint.GetLogStreamRequest.Application.application:type_name -> hashicorp.waypoint.Ref.Application
	121, // 264: hashicorp.waypoint.GetLogStreamRequest.Application.workspace:type_name -> hashicorp.waypoint.Ref.Workspace
	218, // 265: hashicorp.waypoint.LogBatch.Entry.timestamp:type_name -> google.protobuf.Timestamp
	194, // 266: hashicorp.waypoint.ConfigVar.DynamicVal.config:type_name -> hashicorp.waypoint.ConfigVar.DynamicVal.ConfigEntry
	197, // 267: hashicorp.waypoint.ExecStreamRequest.Start.pty:type_name -> hashicorp.waypoint.ExecStreamRequest.PTY
	198, // 268: hashicorp.waypoint.ExecStreamRequest.PTY.window_size:type_name -> hashicorp.waypoint.ExecStreamRequest.WindowSize
	8,   // 269: hashicorp.waypoint.ExecStreamResponse.Output.channel:type_name -> hashicorp.waypoint.ExecStreamResponse.Output.Channel
	197, // 270: hashicorp.waypoint.EntrypointConfig.Exec.pty:type_name -> hashicorp.waypoint.ExecStreamRequest.PTY
	17,  // 271: hashicorp.waypoint.EntrypointConfig.DeploymentInfo.component:type_name -> hashicorp.waypoint.Component
	205, // 272: hashicorp.waypoint.EntrypointConfig.DeploymentInfo.labels:type_name -> hashicorp.waypoint.EntrypointConfig.DeploymentInfo.LabelsEntry
	9,   // 273: hashicorp.waypoint.EntrypointExecRequest.Output.channel:type_name -> hashicorp.waypoint.EntrypointExecRequest.Output.Channel
	219, // 274: hashicorp.waypoint.EntrypointExecRequest.Error.error:type_name -> google.rpc.Status
	12,  // 275: hashicorp.waypoint.Snapshot.Header.version:type_name -> hashicorp.waypoint.VersionInfo
	10,  // 276: hashicorp.waypoint.Snapshot.Header.format:type_name -> hashicorp.waypoint.Snapshot.Header.Format
	217, // 277: hashicorp.waypoint.Snapshot.BoltChunk.items:type_name -> hashicorp.waypoint.Snapshot.BoltChunk.ItemsEntry
	221, // 278: hashicorp.waypoint.Waypoint.GetVersionInfo:input_type -> google.protobuf.Empty
	221, // 279: hashicorp.waypoint.Waypoint.ListWorkspaces:input_type -> google.protobuf.Empty
	53,  // 280: hashicorp.waypoint.Waypoint.GetWorkspace:input_type -> hashicorp.waypoint.GetWorkspaceRequest
	55,  // 281: hashicorp.waypoint.Waypoint.UpsertProject:input_type -> hashicorp.waypoint.UpsertProjectRequest
	57,  // 282: hashicorp.waypoint.Waypoint.GetProject:input_type -> hashicorp.waypoint.GetProjectRequest
	221, // 283: hashicorp.waypoint.Waypoint.ListProjects:input_type -> google.protobuf.Empty
	60,  // 284: hashicorp.waypoint.Waypoint.UpsertApplication:input_type -> hashicorp.waypoint.UpsertApplicationRequest
	64,  // 285: hashicorp.waypoint.Waypoint.ListBuilds:input_type -> hashicorp.waypoint.ListBuildsRequest
	67,  // 286: hashicorp.waypoint.Waypoint.GetBuild:input_type -> hashicorp.waypoint.GetBuildRequest
	74,  // 287: hashicorp.waypoint.Waypoint.ListPushedArtifacts:input_type -> hashicorp.waypoint.ListPushedArtifactsRequest
	73,  // 288: hashicorp.waypoint.Waypoint.GetPushedArtifact:input_type -> hashicorp.waypoint.GetPushedArtifactRequest
	80,  // 289: hashicorp.waypoint.Waypoint.ListDeployments:input_type -> hashicorp.waypoint.ListDeploymentsRequest
	83,  // 290: hashicorp.waypoint.Waypoint.ListInstances:input_type -> hashicorp.waypoint.ListInstancesRequest
	77,  // 291: hashicorp.waypoint.Waypoint.GetDeployment:input_type -> hashicorp.waypoint.GetDeploymentRequest
	66,  // 292: hashicorp.waypoint.Waypoint.GetLatestBuild:input_type -> hashicorp.waypoint.GetLatestBuildRequest
	72,  // 293: hashicorp.waypoint.Waypoint.GetLatestPushedArtifact:input_type -> hashicorp.waypoint.GetLatestPushedArtifactRequest
	89,  // 294: hashicorp.waypoint.Waypoint.ListReleases:input_type -> hashicorp.waypoint.ListReleasesRequest
	91,  // 295: hashicorp.waypoint.Waypoint.GetRelease:input_type -> hashicorp.waypoint.GetReleaseRequest
	88,  // 296: hashicorp.waypoint.Waypoint.GetLatestRelease:input_type -> hashicorp.waypoint.GetLatestReleaseRequest
	93,  // 297: hashicorp.waypoint.Waypoint.GetLogStream:input_type -> hashicorp.waypoint.GetLogStreamRequest
	100, // 298: hashicorp.waypoint.Waypoint.StartExecStream:input_type -> hashicorp.waypoint.ExecStreamRequest
	96,  // 299: hashicorp.waypoint.Waypoint.SetConfig:input_type -> hashicorp.waypoint.ConfigSetRequest
	98,  // 300: hashicorp.waypoint.Waypoint.GetConfig:input_type -> hashicorp.waypoint.ConfigGetRequest
	46,  // 301: hashicorp.waypoint.Waypoint.CreateHostname:input_type -> hashicorp.waypoint.CreateHostnameRequest
	50,  // 302: hashicorp.waypoint.Waypoint.DeleteHostname:input_type -> hashicorp.waypoint.DeleteHostnameRequest
	48,  // 303: hashicorp.waypoint.Waypoint.ListHostnames:input_type -> hashicorp.waypoint.ListHostnamesRequest
	22,  // 304: hashicorp.waypoint.Waypoint.QueueJob:input_type -> hashicorp.waypoint.QueueJobRequest
	24,  // 305: hashicorp.waypoint.Waypoint.CancelJob:input_type -> hashicorp.waypoint.CancelJobRequest
	29,  // 306: hashicorp.waypoint.Waypoint.GetJob:input_type -> hashicorp.waypoint.GetJobRequest
	30,  // 307: hashicorp.waypoint.Waypoint._ListJobs:input_type -> hashicorp.waypoint.ListJobsRequest
	25,  // 308: hashicorp.waypoint.Waypoint.ValidateJob:input_type -> hashicorp.waypoint.ValidateJobRequest
	32,  // 309: hashicorp.waypoint.Waypoint.GetJobStream:input_type -> hashicorp.waypoint.GetJobStreamRequest
	42,  // 310: hashicorp.waypoint.Waypoint.GetRunner:input_type -> hashicorp.waypoint.GetRunnerRequest
	221, // 311: hashicorp.waypoint.Waypoint.GetServerConfig:input_type -> google.protobuf.Empty
	43,  // 312: hashicorp.waypoint.Waypoint.SetServerConfig:input_type -> hashicorp.waypoint.SetServerConfigRequest
	221, // 313: hashicorp.waypoint.Waypoint.CreateSnapshot:input_type -> google.protobuf.Empty
	115, // 314: hashicorp.waypoint.Waypoint.RestoreSnapshot:input_type -> hashicorp.waypoint.RestoreSnapshotRequest
	221, // 315: hashicorp.waypoint.Waypoint.BootstrapToken:input_type -> google.protobuf.Empty
	111, // 316: hashicorp.waypoint.Waypoint.GenerateInviteToken:input_type -> hashicorp.waypoint.InviteTokenRequest
	221, // 317: hashicorp.waypoint.Waypoint.GenerateLoginToken:input_type -> google.protobuf.Empty
	113, // 318: hashicorp.waypoint.Waypoint.ConvertInviteToken:input_type -> hashicorp.waypoint.ConvertInviteTokenRequest
	35,  // 319: hashicorp.waypoint.Waypoint.RunnerConfig:input_type -> hashicorp.waypoint.RunnerConfigRequest
	38,  // 320: hashicorp.waypoint.Waypoint.RunnerJobStream:input_type -> hashicorp.waypoint.RunnerJobStreamRequest
	40,  // 321: hashicorp.waypoint.Waypoint.RunnerGetDeploymentConfig:input_type -> hashicorp.waypoint.RunnerGetDeploymentConfigRequest
	102, // 322: hashicorp.waypoint.Waypoint.EntrypointConfig:input_type -> hashicorp.waypoint.EntrypointConfigRequest
	105, // 323: hashicorp.waypoint.Waypoint.EntrypointLogStream:input_type -> hashicorp.waypoint.EntrypointLogBatch
	106, // 324: hashicorp.waypoint.Waypoint.EntrypointExecStream:input_type -> hashicorp.waypoint.EntrypointExecRequest
	62,  // 325: hashicorp.waypoint.Waypoint.UpsertBuild:input_type -> hashicorp.waypoint.UpsertBuildRequest
	70,  // 326: hashicorp.waypoint.Waypoint.UpsertPushedArtifact:input_type -> hashicorp.waypoint.UpsertPushedArtifactRequest
	78,  // 327: hashicorp.waypoint.Waypoint.UpsertDeployment:input_type -> hashicorp.waypoint.UpsertDeploymentRequest
	86,  // 328: hashicorp.waypoint.Waypoint.UpsertRelease:input_type -> hashicorp.waypoint.UpsertReleaseRequest
	11,  // 329: hashicorp.waypoint.Waypoint.GetVersionInfo:output_type -> hashicorp.waypoint.GetVersionInfoResponse
	52,  // 330: hashicorp.waypoint.Waypoint.ListWorkspaces:output_type -> hashicorp.waypoint.ListWorkspacesResponse
	54,  // 331: hashicorp.waypoint.Waypoint.GetWorkspace:output_type -> hashicorp.waypoint.GetWorkspaceResponse
	56,  // 332: hashicorp.waypoint.Waypoint.UpsertProject:output_type -> hashicorp.waypoint.UpsertProjectResponse
	58,  // 333: hashicorp.waypoint.Waypoint.GetProject:output_type -> hashicorp.waypoint.GetProjectResponse
	59,  // 334: hashicorp.waypoint.Waypoint.ListProjects:output_type -> hashicorp.waypoint.ListProjectsResponse
	61,  // 335: hashicorp.waypoint.Waypoint.UpsertApplication:output_type -> hashicorp.waypoint.UpsertApplicationResponse
	65,  // 336: hashicorp.waypoint.Waypoint.ListBuilds:output_type -> hashicorp.waypoint.ListBuildsResponse
	68,  // 337: hashicorp.waypoint.Waypoint.GetBuild:output_type -> hashicorp.waypoint.Build
	75,  // 338: hashicorp.waypoint.Waypoint.ListPushedArtifacts:output_type -> hashicorp.waypoint.ListPushedArtifactsResponse
	76,  // 339: hashicorp.waypoint.Waypoint.GetPushedArtifact:output_type -> hashicorp.waypoint.PushedArtifact
	81,  // 340: hashicorp.waypoint.Waypoint.ListDeployments:output_type -> hashicorp.waypoint.ListDeploymentsResponse
	84,  // 341: hashicorp.waypoint.Waypoint.ListInstances:output_type -> hashicorp.waypoint.ListInstancesResponse
	82,  // 342: hashicorp.waypoint.Waypoint.GetDeployment:output_type -> hashicorp.waypoint.Deployment
	68,  // 343: hashicorp.waypoint.Waypoint.GetLatestBuild:output_type -> hashicorp.waypoint.Build
	76,  // 344: hashicorp.waypoint.Waypoint.GetLatestPushedArtifact:output_type -> hashicorp.waypoint.PushedArtifact
	90,  // 345: hashicorp.waypoint.Waypoint.ListReleases:output_type -> hashicorp.waypoint.ListReleasesResponse
	92,  // 346: hashicorp.waypoint.Waypoint.GetRelease:output_type -> hashicorp.waypoint.Release
	92,  // 347: hashicorp.waypoint.Waypoint.GetLatestRelease:output_type -> hashicorp.waypoint.Release
	94,  // 348: hashicorp.waypoint.Waypoint.GetLogStream:output_type -> hashicorp.waypoint.LogBatch
	101, // 349: hashicorp.waypoint.Waypoint.StartExecStream:output_type -> hashicorp.waypoint.ExecStreamResponse
	97,  // 350: hashicorp.waypoint.Waypoint.SetConfig:output_type -> hashicorp.waypoint.ConfigSetResponse
	99,  // 351: hashicorp.waypoint.Waypoint.GetConfig:output_type -> hashicorp.waypoint.ConfigGetResponse
	47,  // 352: hashicorp.waypoint.Waypoint.CreateHostname:output_type -> hashicorp.waypoint.CreateHostnameResponse
	221, // 353: hashicorp.waypoint.Waypoint.DeleteHostname:output_type -> google.protobuf.Empty
	49,  // 354: hashicorp.waypoint.Waypoint.ListHostnames:output_type -> hashicorp.waypoint.ListHostnamesResponse
	23,  // 355: hashicorp.waypoint.Waypoint.QueueJob:output_type -> hashicorp.waypoint.QueueJobResponse
	221, // 356: hashicorp.waypoint.Waypoint.CancelJob:output_type -> google.protobuf.Empty
	27,  // 357: hashicorp.waypoint.Waypoint.GetJob:output_type -> hashicorp.waypoint.Job
	31,  // 358: hashicorp.waypoint.Waypoint._ListJobs:output_type -> hashicorp.waypoint.ListJobsResponse
	26,  // 359: hashicorp.waypoint.Waypoint.ValidateJob:output_type -> hashicorp.waypoint.ValidateJobResponse
	33,  // 360: hashicorp.waypoint.Waypoint.GetJobStream:output_type -> hashicorp.waypoint.GetJobStreamResponse
	34,  // 361: hashicorp.waypoint.Waypoint.GetRunner:output_type -> hashicorp.waypoint.Runner
	44,  // 362: hashicorp.waypoint.Waypoint.GetServerConfig:output_type -> hashicorp.waypoint.GetServerConfigResponse
	221, // 363: hashicorp.waypoint.Waypoint.SetServerConfig:output_type -> google.protobuf.Empty
	114, // 364: hashicorp.waypoint.Waypoint.CreateSnapshot:output_type -> hashicorp.waypoint.CreateSnapshotResponse
	221, // 365: hashicorp.waypoint.Waypoint.RestoreSnapshot:output_type -> google.protobuf.Empty
	112, // 366: hashicorp.waypoint.Waypoint.BootstrapToken:output_type -> hashicorp.waypoint.NewTokenResponse
	112, // 367: hashicorp.waypoint.Waypoint.GenerateInviteToken:output_type -> hashicorp.waypoint.NewTokenResponse
	112, // 368: hashicorp.waypoint.Waypoint.GenerateLoginToken:output_type -> hashicorp.waypoint.NewTokenResponse
	112, // 369: hashicorp.waypoint.Waypoint.ConvertInviteToken:output_type -> hashicorp.waypoint.NewTokenResponse
	36,  // 370: hashicorp.waypoint.Waypoint.RunnerConfig:output_type -> hashicorp.waypoint.RunnerConfigResponse
	39,  // 371: hashicorp.waypoint.Waypoint.RunnerJobStream:output_type -> hashicorp.waypoint.RunnerJobStreamResponse
	41,  // 372: hashicorp.waypoint.Waypoint.RunnerGetDeploymentConfig:output_type -> hashicorp.waypoint.RunnerGetDeploymentConfigResponse
	103, // 373: hashicorp.waypoint.Waypoint.EntrypointConfig:output_type -> hashicorp.waypoint.EntrypointConfigResponse
	221, // 374: hashicorp.waypoint.Waypoint.EntrypointLogStream:output_type -> google.protobuf.Empty
	107, // 375: hashicorp.waypoint.Waypoint.EntrypointExecStream:output_type -> hashicorp.waypoint.EntrypointExecResponse
	63,  // 376: hashicorp.waypoint.Waypoint.UpsertBuild:output_type -> hashicorp.waypoint.UpsertBuildResponse
	71,  // 377: hashicorp.waypoint.Waypoint.UpsertPushedArtifact:output_type -> hashicorp.waypoint.UpsertPushedArtifactResponse
	79,  // 378: hashicorp.waypoint.Waypoint.UpsertDeployment:output_type -> hashicorp.waypoint.UpsertDeploymentResponse
	87,  // 379: hashicorp.waypoint.Waypoint.UpsertRelease:output_type -> hashicorp.waypoint.UpsertReleaseResponse
