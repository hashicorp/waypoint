// Package terraform contains helpers to execute Terraform in automation.
// The expectation of this package is that this is the only user executing
// Terraform on this machine.
package terraform
