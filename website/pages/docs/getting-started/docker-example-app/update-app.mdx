...
You will notice that the Deployment URL for this second deployment is different. This is because Waypoint generates
unique URLs for each deployment as well, to allow them to be accessed directly. This is typically used to preview
a deployment before releasing it.
