...
-> Review the [prerequisites for this walkthrough](docs/getting-started/docker-example-app/install-prereqs) before installing Waypoint. You will use the `Ruby` application in the examples for this walkthrough.
