...
You may also install the server to a Kubernetes cluster rn [Nomad cluster](https://nomadproject.io). To learn more about Kubernetes, see the getting started guide for [deploying an app to Kubernetes](/docs/getting-started/k8s-example-app/install-waypoint) on AWS Elastic Kubernetes Service (EKS). This walkthrough shows you how to deploy the server and an example app to Kubernetes.
