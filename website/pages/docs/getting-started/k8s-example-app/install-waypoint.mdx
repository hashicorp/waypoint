...
-> Review the [prerequisites for this walkthrough](docs/getting-started/k8s-example-app/install-prereqs) before installing Waypoint. You will use the `ReactJS` application in the examples for this walkthrough.
