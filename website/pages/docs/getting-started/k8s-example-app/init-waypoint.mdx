...
file that you copied over in the previous steps. Ensure you are in the `waypoint-examples/reactjs` directory and we can inspect this `waypoint.hcl` with the following command
