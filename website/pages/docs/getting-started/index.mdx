...
sidebar_title: Get Started with Waypoint
description: |-
  Placeholder
---
...
## Deploy Your First App with Waypoint
...
### Deploy an app to Docker Desktop

- Time required: About 10 minutes
- Prerequisites: Docker Desktop
- [Try Waypoint now](/docs/getting-started/docker-example-app)

### Deploy an app to Kubernetes on Amazon Elastic Kubernetes Service (EKS)
