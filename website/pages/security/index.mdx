...
layout: index
page_title: Security
description: Waypoint takes security very seriously. Please responsibly disclose any security vulnerabilities found and we'll handle it quickly.
---
...
open an issue on the standard [GitHub](https://github.com/hashicorp/waypoint)
repository.
