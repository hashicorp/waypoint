...
write configuration files for [Terraform](/terraform/language) and [Waypoint](/waypoint/docs/waypoint-hcl/syntax).
...
- [Nomad](/nomad/tutorials/get-started/get-started-intro) cluster on AWS EC2 instance to manage application containers.
...
You can [read more about Waypoint HCL](/waypoint/docs/waypoint-hcl) fundamentals,
...
You can also deploy the application by [installing self-hosted Waypoint](/waypoint/commands/install)
...
- [Deploy an Application to Nomad with Waypoint](/waypoint/tutorials/get-started-nomad/get-started-nomad)
- [Set Up a Nomad Cluster on AWS](/nomad/tutorials/cluster-setup/cluster-setup-aws)
- [Blue-Green Deployments with Waypoint, Nomad, and Consul](/waypoint/docs/use-cases/blue-green-deployment)
- [Consul Deployment Guide](/consul/tutorials/production-deploy/deployment-guide)
- [Advanced Deployment Pipelines with Waypoint](/waypoint/docs/pipelines)
