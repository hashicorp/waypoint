...
deploying, and releasing may prove to be difficult since you can't release cross
platform in the same manner. Waypoint can solve those problems. With Waypoint, it is
...
##### Step 1. Start with an existing cluster and application deployed
