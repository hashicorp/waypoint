...
remote operations and how they work, check out [the documentation](https://developer.hashicorp.com/waypoint/docs/projects/remote).
...
and push it to a new registry after adding the [Waypoint Entrypoint](https://developer.hashicorp.com/waypoint/docs/entrypoint).
...
this in the [Consul documentation](https://developer.hashicorp.com/consul/docs/k8s/connect/health).
