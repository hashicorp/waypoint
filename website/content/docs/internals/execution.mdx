...
description: >-
  This page documents how operations such as build, deploy, and release execute
  within Waypoint. This helps explain what components need access to what
  systems and how information flows within Waypoint.
---
