...
_Kubernetes with a Private Registry_
...
_Docker with a Private Registry_
...
of band" Docker authenication configured directly with Docker.

_Nomad with a Private Registry_
...
_Other Platforms with a Private Registry_
