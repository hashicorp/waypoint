...
### Project and App Lables

Labels can also be specified at both the project and app scope. These
lable are inherited by all operations within the project and application.
...
usage beyond simple informational tasks to remain for advanced concepts.
