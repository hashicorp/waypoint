...
description: >-
  You can specify alternate configurations for lifecycle operations based on the
  current workspace or labels. This can be used to change configurations between
...
1. The longest label selector string by byte count (ignoring preceding or trailing
