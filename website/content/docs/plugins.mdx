...
anywhere. This page will focus on _using_ plugins. We will publish more
documentation on writing plugins later.
...
Anywhere you see a [`use` stanza](/docs/waypoint-hcl/use) is a place where
a plugin is used.

## Available Plugins

You can see a list of [all built-in plugins here](/docs/plugins).
