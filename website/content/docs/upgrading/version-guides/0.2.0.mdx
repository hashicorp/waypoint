...
sidebar_title: Upgrade to 0.2.0
description: |-
...
Waypoint 0.1.x can be upgraded to Waypoint 0.2.0 using a [standard upgrade](/Adocs/upgrading#standard-upgrade).
...
compatible but we encourge user to upgrade all to 0.2.x over time.
