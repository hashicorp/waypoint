...
description: >-
  This upgrade guide describes any considerations for upgrading to Waypoint
  0.2.0.
---
...
compatible but we encourge users to upgrade all components to 0.2.x over time.
