...
description: This section contains upgrade guides for specific Waypoint versions.
---
...
you're upgrading from version 0.1.0 to 0.3.0, please read the guide for 0.3.0
as well as any guide in between. Each upgrade guide will assume you're already
