...
The `-plugin-config` flag lets you modify the way the plugin of interest launches tasks. For example, to edit the Kubernetes default runner profile's plugin config to use a
