...
## \*component.Source (https://golang.org/pkg/context/)
...
## \*component.JobInfo (https://golang.org/pkg/context/)
...
## \*component.DeploymentConfig (https://golang.org/pkg/context/)
...
## hclog.Logger (https://godoc.org/github.com/hashicorp/go-hclog)

Logger provides you with the ability to write to the Waypoint standard logger using different log levels such as
Info, Debug, Trace, etc. By default log output is disable when running a waypoint command. The environment variable
