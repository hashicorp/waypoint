...
[Default Parameters](/waypoint/docs/extending-waypoint/plugin-interfaces/default-parameters) documentation.
...
[specific documentation](/waypoint/docs/extending-waypoint/passing-values).
...
[Next - Compiling the Plugin](/waypoint/docs/extending-waypoint/creating-plugins/compiling)
