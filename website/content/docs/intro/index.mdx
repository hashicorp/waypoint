...
description: >-
  Welcome to Waypoint! This introduction section covers what Waypoint is, the
  problem Waypoint aims to solve, and how Waypoint compares to other software.
---
...
1. **Confidence in Deployment.** The first thing any developer does after
...
1. **Extensibility with the Ecosystem.** Consistency is only useful if
