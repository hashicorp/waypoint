...
[`kubectl apply`](/plugins/kubernetes#kubernetes-apply-platform) as first-class
...
With one more line of configuration, you can scale your application to more repliacs:
...
environment variable set by Waypoint. You may change or add ports
using the `ports` variable:
