...
description: >-
  ...
  configuration, logs, exec, and more.
---
...
1. Put the single binary Waypoint entrypoint anywhere in your deployment
   image, such as `/usr/local/bin` on Unix-like systems.

1. Configure your application startup to run the entrypoint first rather
