...
description: >-
  The entrypoint can be disabled by disabling build-time injection or by setting
  a runtime variable in already-built artifacts.
---
...
The example below shows how to set this using the [Kubernetes plugin](/plugins/kubernetes):
