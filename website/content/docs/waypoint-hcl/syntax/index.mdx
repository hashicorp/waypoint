...
[expressions](/waypoint/docs/waypoint-hcl/syntax/expressions) which allow the value to
...
sidebar to the left. The documentation uses [placement tables](/waypoint/docs/waypoint-hcl#placement-tables)
