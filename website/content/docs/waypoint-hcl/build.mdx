...
description: >-
  The `build` stanza describes how an application is built. During the build
  operation, Waypoint converts application source into an artifact and
  optionally pushes it to a remote registry.
---
