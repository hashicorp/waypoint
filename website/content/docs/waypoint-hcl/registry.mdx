...
description: >-
  The `registry` stanza configures the result of a build to be pushed to a
  registry such as a Docker Registry, Artifactory, etc. A registry is used to
  make the result of a build available to the deployment platform.
---
