...
description: >-
  The `url` stanza configures the behavior of the [URL service](/docs/url) for
  the given application. This allows for certain applications to opt-out of the
  URL service, opt-in, etc.
---
