...
waypoint.hcl, and setting their values using CLI options, environment variables,
...
`variable` block. Example variable declaration blocks include:
...
within [expressions](/docs/waypoint-hcl/syntax/expressions) as `var.<NAME>`,
