...
description: >-
  The `waypoint.hcl` file uses HCL which is able to reference predefined
  variables. This section documents the list of available variables within the
  `waypoint.hcl`.
---
...
Waypoint supports [custom input variables](variables/input), predefined
