...
The plugin name must match the name of a [built-in plugin](/plugins)
or an [external plugin](#TODO). The plugin will be validated as part of
...
the available parameters [documented here](/plugins/docker#docker-builder).
