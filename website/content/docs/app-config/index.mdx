...
the same thing as the [`waypoint config set`](/commands/config-set) example in the section above.
...
- The configuration is made available immediately during all [`waypoint up`](/commands/up).
