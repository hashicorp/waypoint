...
- `-git-path=<string>` - Path is a subdirectory within the checked out repository to go into for the configuration. This must be a relative path and may not contain '..'
