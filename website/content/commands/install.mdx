...
- `-k8s-helm-ref=<string>` - The git ref of the Helm chart to use for the Waypoint install. The ref may also be a branch name like 'main'. Takes precedent over -k8s-helm-version.
