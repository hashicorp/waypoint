...
1. Write a bootstrap token to the given Kubernetes secret
1. Create a token for a static runner and write it to the configured
   Kubernetes secret.
1. Configure Kubernetes on-demand runners.
