...
- `-context-create=<string>` - Create a CLI context for this bootstrapped server. The context name will be the value of this flag. If this is an empty string, a context will not be created The default is bootstrap-1656374441.
