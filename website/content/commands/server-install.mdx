...
- `-ecs-task-role-name=<string>` - Configures the IAM Task Role for both the default runner, and all the On-Demand Runners. If this is blank, a IAM Role will be created automatically with the correct permissions.
