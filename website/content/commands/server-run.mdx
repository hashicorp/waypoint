...
- `-telemetry-opencensus-agent-addr=<string>` - Address of an opencensus agent or collector available to receive opencensus formatted
...
- `-telemetry-opencensus-zpages-addr=<string>` - If set, waypoint will run a telemetry zpages server at this address. Typically this is
