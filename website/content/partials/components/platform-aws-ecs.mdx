...
##### <NestedNode>alb.certificate</NestedNode>
...
##### <NestedNode>alb.domain_name</NestedNode>
...
##### <NestedNode>alb.internal</NestedNode>
...
##### <NestedNode>alb.listener_arn</NestedNode>
...
##### <NestedNode>alb.zone_id</NestedNode>
...
##### <NestedNode>logging.create_group</NestedNode>
...
##### <NestedNode>logging.datetime_format</NestedNode>
...
##### <NestedNode>logging.max_buffer_size</NestedNode>
...
##### <NestedNode>logging.mode</NestedNode>
...
##### <NestedNode>logging.multiline_pattern</NestedNode>
...
##### <NestedNode>logging.region</NestedNode>

The region the logs are to be shipped to.

##### <NestedNode>logging.stream_prefix</NestedNode>
